...
export default function MoreNews() {
	...
	return (
		<>
			<div className="grid w-full xl:max-w-[82vw] lg:max-w-[90vw] flex-col gap-x-4 gap-y-3 py-2 customMd:w-full xl:grid-cols-3 customMd:grid-cols-2 lg:flex-row lg:gap-x-6 xl:px-20">
